...
exports.criarProduto = async (req, res) => {
  ...
  try {
    const { id_produto, nome_produto, preco, quantidade_estoque} = req.body;
    ...
    const result = await query(
      'INSERT INTO produto (id_produto, nome_produto, preco, quantidade_estoque) VALUES ($1, $2, $3, $4) RETURNING *',
...
const updatedFields = {
  ...
  `UPDATE produto 
   SET nome_produto = $1, preco = $2, quantidade_estoque = $3 WHERE id_produto = $4 RETURNING *`,
  [updatedFields.nome_produto, updatedFields.preco, updatedFields.quantidade_estoque, id]
);
