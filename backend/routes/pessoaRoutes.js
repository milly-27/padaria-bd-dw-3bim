...
exports.criarPessoa = async (req, res) => {
  ...
  try {
    const { id_pessoa, nome_pessoa, email_pessoa, senha_pessoa, apelido_pessoa = true } = req.body;
    ...
    const result = await query(
      'INSERT INTO pessoa (id_pessoa, nome_pessoa, email_pessoa, senha_pessoa, apelido_pessoa) VALUES ($1, $2, $3, $4, $5, $6) RETURNING *',
